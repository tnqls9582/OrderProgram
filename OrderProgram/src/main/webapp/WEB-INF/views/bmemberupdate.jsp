...
<script>
	function updatefn() {
		...
		var pw = '${bmemberUpdate.bpassword}';
		if(pwcheck == pw) {
			updateform.submit();
		} else {
...
<!------ Include the above in your HEAD tag ---------->
	<nav class="main-navigation">
        ...
        <ul class="nav-list">
            ...
            <li class="nav-list-item">
                <a href="orderview" class="nav-link">발주목록</a>
            </li>
            <li class="nav-list-item">
    ...
    <form action="bupdateprocess" method="post" name="updateform">
    	<a>${sessionScope.loginMember} 님</a><br>
    	비밀번호 <input type="password" name="bpassword" id="pw"><br>
    	사업자등록번호 <input type="text" name="brnumber" value="${bmemberUpdate.brnumber}" readonly><br>
    	업체명 <input type="text" name="bname" value="${bmemberUpdate.bname}"><br>
    	연락처 <input type="text" name="bphone" value="${bmemberUpdate.bphone}"><br>
    	주소 <input type="text" name="baddress" value="${bmemberUpdate.baddress}"><br>
