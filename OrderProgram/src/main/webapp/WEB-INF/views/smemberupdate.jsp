...
<!------ Include the above in your HEAD tag ---------->
    ...
    <form action="supdateprocess" method="post" name="updateform">
    	...
    	비밀번호 <input type="password" name="spassword" id="pw"><br>
    	사업자등록번호 <input type="text" name="srnumber" value="${smemberUpdate.srnumber}" readonly><br>
    	업체명 <input type="text" name="sname" value="${smemberUpdate.sname}"><br>
    	연락처 <input type="text" name="sphone" value="${smemberUpdate.sphone}"><br>
    	주소 <input type="text" name="saddress" value="${smemberUpdate.saddress}"><br>
