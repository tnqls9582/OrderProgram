...
<div class="container">
	...
	<div class="login-form">
		<div class="main-div">
		    ...
		    <form action="bmemberjoin" id="Login" method="post">
				<div class="form-group">
					<input type="text" class="form-control" name="bid" id="bid" placeholder="아이디" onblur="idcheck()">
					<span id="idcheck"></span>
				</div>
				
				<div class="form-group">
					<input type="password" class="form-control" name="bpassword" id="pw" placeholder="비밀번호" onblur="pwcheck()">
					<span id="pwcheck"></span>
				</div>
				
				<div class="form-group">
					<input type="password" class="form-control" name="bpasswordcheck" id="pwc" placeholder="비밀번호 확인" onblur="pwresult()">
					<span id="pwresult"></span>
				</div>
				
				<div class="form-group">
					<input type="text" class="form-control" name="brnumber" id="rnb" placeholder="사업자등록번호" onblur="rncheck()">
					<span id="rncheck"></span>
				</div>
				
				<div class="form-group">
					<input type="text" class="form-control" name="bname" id="name" placeholder="업체명" onblur="namecheck()">
					<span id="namecheck"></span>
				</div>
		
				<div class="form-group">
					<input type="text" class="form-control" name="bphone" id="phone" placeholder="연락처" onblur="phonecheck()">
					<span id="phonecheck"></span>
				</div>
				
				<!-- 다음주소 -->
				<div class="form-group">
					<input type="text" class="form-control" id="sample4_postcode" name="baddress" placeholder="우편번호" onblur="addcheck()">
					<span id="addcheck"></span>
					<input type="button" onclick="sample4_execDaumPostcode()" value="우편번호 찾기"><br>
				</div>
				
				<div class="form-group">
					<input type="text" class="form-control" id="sample4_jibunAddress" name="baddress" placeholder="지번주소">
					<span id="guide" class="form-control" style="color:#999;display:none"></span>
				</div>
				
				<div class="form-group">
					<input type="text" class="form-control" id="sample4_extraAddress" name="baddress" placeholder="참고항목">
				</div>
				
				<div class="form-group">
					<input type="text" class="form-control" id="sample4_roadAddress" name="baddress" placeholder="도로명주소">
				</div>
				
				<div class="form-group">
					<input type="text" class="form-control" id="sample4_detailAddress" name="baddress" placeholder="상세주소">
				</div>
